...
public class DatabaseMovieWriter implements MovieWriter{
    ...
    public DatabaseMovieWriter(String connection) throws SQLException {
        ...
        this.insertStatement = innitDatabase(this.connection);
    }

    private PreparedStatement innitDatabase(Connection connection) throws SQLException {
        Statement statement = connection.createStatement();
        statement.execute(CreateTableStatement);
        return connection.prepareStatement(InsertRecordStatement);
    }

    public DatabaseMovieWriter(File file) throws SQLException { this(connectionFor(file)); }
